// AUTOGENERATED FILE
// This file was generated from weapons.ohm by `ohm generateBundles`.
...
export interface AccuracyActionDict<T> extends BaseActionDict<T> {
  ...
  AccuracyValue?: (this: NonterminalNode, arg0: NonterminalNode) => T;
...
export interface DamageActionDict<T> extends BaseActionDict<T> {
  ...
  Total_radiusNoDamage?: (this: NonterminalNode, arg0: NonterminalNode) => T;
...
export interface AvailabilityActionDict<T> extends BaseActionDict<T> {
  ...
  Next?: (this: NonterminalNode, arg0: NonterminalNode) => T;
  AddSub_add?: (
    this: NonterminalNode,
    arg0: NonterminalNode,
    arg1: TerminalNode,
