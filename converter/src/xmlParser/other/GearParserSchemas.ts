import { personaFormEnum } from "@neon-codex/common/build/enums.js";
...
export const GearListXmlSchema = zod.array(GearXmlSchema);
export type GearListXmlType = zod.infer<typeof GearListXmlSchema>;
