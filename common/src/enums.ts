export enum skillsEnum {
  ...
  Blades = "Blades",
  Clubs = "Clubs",
  ExoticMeleeWeapon = "Exotic Melee Weapon",
  ExoticRangedWeapon = "Exotic Ranged Weapon",
  ...
  // Technical Skills
  AeronauticsMechanic = "AeronauticsMechanic",
  AnimalHandling = "AnimalHandling",
  Armourer = "Armourer",
  Artisan = "Artisan",
  AutomotiveMechanic = "AutomotiveMechanic",
  ...
  Hacking = "Hacking",
  Hardware = "Hardware",
  IndustrialMechanic = "IndustrialMechanic",
  Locksmith = "Locksmith",
  Medicine = "Medicine",
  NauticalMechanic = "NauticalMechanic",
